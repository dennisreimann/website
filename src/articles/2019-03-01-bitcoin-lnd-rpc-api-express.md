...
<mark>Practically, when you are building use cases you often want to aggregate and enhance the payloads of the original API calls.</mark>
...
<mark>It allows us to process each of the different request uniformly, as we see in the `map` function which defined the actual Express routes:</mark>
